...
## Annexes 5 - Investigation numérique


## Annexe 6,7,8 - Analyse de malware

### Volatility 3 sur Debian	
> La version de Debian utilisée est la _debian-12.6.0-amd64-netinst.iso_ téléchargeable directement sur [Debian.org](https://cdimage.debian.org/debian-cd/current/amd64/iso-cd/debian-12.6.0-amd64-netinst.iso)	

#### Prérequis	
- Installer [VirtualBox](https://www.virtualbox.org/wiki/Downloads)	
- Ajouter l'[Oracle VirtualBox Extension Pack](https://www.virtualbox.org/wiki/Downloads) (optionnel)	
- Créer une nouvelle machine virtuelle et installer [Debian](https://cdimage.debian.org/debian-cd/current/amd64/iso-cd/debian-12.6.0-amd64-netinst.iso)	
- Installer les [Additions invités de VirtualBox](https://linuxconfig.org/install-virtualbox-guest-additions-on-linux-guest)	

#### Installer Volatility 3 sur Debian	

**Passez en _superutilisateur_ (root)**	
on n'oublie pas de faire un `apt update`	

> télécharger volatility3	
```
git clone https://github.com/volatilityfoundation/volatility3.git
```

> configurer un environnement virtuel dédié	
```	
python3 -m venv venv	
...
#### Utiliser Volatility 3	  
`root@local:~/volatility3# python3 vol.py`	  

Arguments :   
**-vvvv**    -> (mode très verbeux, idéal pour afficher les erreurs)	  
**-f**       -> file (fichier à analyser. _Exemple : infected/dump.raw_)	  
**_plugin_** -> choisir un plugin disponible. La liste s'affiche en utilisant `vol.py -h`	  

##### Plugins Volatility 3	
voici quelques plugins utilisables sur une image Windows	
